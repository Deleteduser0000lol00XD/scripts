...
function OrionLib:MakeNotification(NotificationConfig)
    spawn(function()
        ...
        TweenService:Create(Icon, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            ImageTransparency = 1
        }):Play()
        ...
        TweenService:Create(ProgressOuter, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            BackgroundTransparency = 1
        }):Play()

        TweenService:Create(ProgressInner, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            BackgroundTransparency = 1
        }):Play()
        ...
        TweenService:Create(ProgressHighlight, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            BackgroundTransparency = 1
        }):Play()

        TweenService:Create(ProgressTip, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            BackgroundTransparency = 1
        }):Play()

        TweenService:Create(ProgressOuterStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {
            Transparency = 1
        }):Play()
        ...
        TweenService:Create(Content, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {
