	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddColorpicker(ColorpickerConfig)
                ...
                local R_Input = CreateStyledInput(45, 30, 12, 45)
                local G_Input = CreateStyledInput(45, 30, 62, 45)
                local B_Input = CreateStyledInput(45, 30, 112, 45)
                ...
                local ColorpickerFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                    ...
                    SetProps(SetChildren(MakeElement("TFrame"), {
                        ...
                        R_Input, G_Input, B_Input, Full_Input,
                        ColorpickerBox,
                        Click,
                        AddThemeObject(SetProps(MakeElement("Frame"), {
                            Size = UDim2.new(1, 0, 0, 1),
                ...
                AddConnection(Click.MouseButton1Click, function()
                    ...
                    TweenService:Create(ColorpickerFrame, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        Size = Colorpicker.Toggled and UDim2.new(1, 0, 0, 145) or UDim2.new(1, 0, 0, 38)
                    }):Play()
                    ...
                    Full_Input.Visible = Colorpicker.Toggled
                ...
                local function OnInputChanged()
                    ...
                    HueSelection.Position = UDim2.new(ColorH, 0, 0.5, 0)
                    Color.BackgroundColor3 = Color3.fromHSV(ColorH, 1, 1)
                ...
                Full_Input.FocusLost:Connect(OnFullInputChanged)
